programa {
  ...
  logico flagNotaPonderada = falso
  inteiro x = 0, qtdeAlunos = 0
  cadeia enter
  real notaPonderada1, notaPonderada2, notaPonderada3
  ...
  funcao listarNota(cadeia nomeAlunos[], real nota1[],real nota2[],real nota3[]) {
    ...
    senao se (flagMediasCalculadas == verdadeiro e flagNotaPonderada == verdadeiro)
    {

      para (inteiro k = 0; k < qtdeAlunos; k++)
      {
        escreva ("Nome: ", nomeAlunos[k]," | Nota 1: ", (nota1[k] * notaPonderada1), " | Nota 2: ", (nota2[k] * notaPonderada2), " | Nota 3: ", (nota3[k] * notaPonderada3), " | Média: ", ((nota1[k] * notaPonderada1) + (nota2[k] * notaPonderada2) + (nota3[k] * notaPonderada3)) / 3)
      }
  ...
  funcao calcularMedia(cadeia nomeAlunos[], real nota1[],real nota2[],real nota3[]) {
    ...
    se (flagNotasColetadas == verdadeiro)
    {
      ...
      escreva ("Deseja calcular a média normal ou a média ponderada?\nDigite N para média normal ou P para média ponderada: ")
      leia (tipoMedia)

      se (Texto.caixa_alta(tipoMedia) == 'N')
      {
        para (inteiro k = 0; k < qtdeAlunos; k++)
        {
      ...
      senao se ((Texto.caixa_alta(tipoMedia)) == 'P')
      {
        escreva("Digite o Valor para a nota ponderada 1: ")
        leia (notaPonderada1)
        
        escreva("Digite o Valor para a nota ponderada 2: ")
        leia (notaPonderada3)
        
        escreva("Digite o Valor para a nota ponderada 3: ")
        leia (notaPonderada2)
  ...
  funcao imprimeQtdeAlunos(){
    ...
    enquanto (qtdeAlunos <= 0)
    {
      se (qtdeAlunos <= 0)
      {
        limpa()
        escreva("Seja bem vindo \n")
        escreva("Por favor, informe a quantidade de alunos (Maior que 1 por favor):\n")
        leia(qtdeAlunos)
        limpa()
      }
    }
